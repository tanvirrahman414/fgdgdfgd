...
import { VPSFeatures } from "./VPSFeatures";
import productsData from "../../data/products";

export function VPSPage({ onPurchase }) {
  const { plans, images } = productsData.vps;
    ...
    <div className="max-w-7xl mx-auto px-4 py-20 fade-in">
      <div className="text-center mb-16">
        ...
        <p className="font-inter text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          24/7 cloud servers with full admin access for uninterrupted trading
        </p>
      </div>
